...
SqliteSourceImpl::SqliteSourceImpl( const SqliteSourceImplPolicy &policy )
    : _db (NULL)
    , _idmap (NULL)
{}
...
SqliteSourceImpl::createAtoms(void)
{
  ...
  sqlite3_bind_text (handle, 1, selfSourceRef().id().c_str(), -1, SQLITE_STATIC);
  ...
  while ((rc = sqlite3_step (handle)) == SQLITE_ROW)
  {
    ...
    try
    {
      ...
      detail::ResImplTraits<SqliteAtomImpl>::Ptr impl( new SqliteAtomImpl( selfSourceRef(), id ) );
    ...
    {
      ERR << "Cannot create atom object '" << name << "' from catalog '" << selfSourceRef().id() << "'" << endl;
...
SqliteSourceImpl::createMessages(void)
{
  ...
  while ((rc = sqlite3_step (handle)) == SQLITE_ROW)
  {
    ...
    try
    {
      ...
      detail::ResImplTraits<SqliteMessageImpl>::Ptr impl( new SqliteMessageImpl( selfSourceRef(), TranslatedText( content ), id ) );
    ...
    {
      ERR << "Cannot create message object '" << name << "' from catalog '" << selfSourceRef().id() << "'" << endl;
      sqlite3_reset (handle);
      ZYPP_RETHROW (excpt_r);
    }
  }
...
SqliteSourceImpl::createScripts(void)
{
  ...
  while ((rc = sqlite3_step (handle)) == SQLITE_ROW)
  {
    ...
    try
    {
      ...
      detail::ResImplTraits<SqliteScriptImpl>::Ptr impl( new SqliteScriptImpl( selfSourceRef(), do_script, undo_script, id ) );
    ...
    {
      ERR << "Cannot create script object '" << name << "' from catalog '" << selfSourceRef().id() << "'" << endl;
      sqlite3_reset (handle);
      ZYPP_RETHROW (excpt_r);
    }
  }
...
SqliteSourceImpl::createLanguages(void)
{
  ...
  while ((rc = sqlite3_step (handle)) == SQLITE_ROW)
  {
    ...
    try
    {
      ...
      detail::ResImplTraits<SqliteLanguageImpl>::Ptr impl( new SqliteLanguageImpl( selfSourceRef(), id ) );
    ...
    {
      ERR << "Cannot create language object '" << name << "' from catalog '" << selfSourceRef().id() << "'" << endl;
      sqlite3_reset (handle);
      ZYPP_RETHROW (excpt_r);
    }
  }
...
SqliteSourceImpl::createPackages(void)
{
  ...
  while ((rc = sqlite3_step (handle)) == SQLITE_ROW)
  {
    ...
    try
    {
      detail::ResImplTraits<SqlitePackageImpl>::Ptr impl( new SqlitePackageImpl( selfSourceRef() ) );
    ...
    {
      ERR << "Cannot create package object '" << name << "' from catalog '" << selfSourceRef().id() << "'" << endl;
      sqlite3_reset (handle);
      ZYPP_RETHROW (excpt_r);
    }
  }
...
SqliteSourceImpl::createPatches(void)
{
  ...
  while ((rc = sqlite3_step (handle)) == SQLITE_ROW)
  {
    ...
    try
    {
      detail::ResImplTraits<SqlitePatchImpl>::Ptr impl( new SqlitePatchImpl( selfSourceRef() ) );
      
      sqlite_int64 id = sqlite3_column_int64( handle, PATCHES_TABLE_COLUMN_ID );
      name = (const char *) sqlite3_column_text( handle, PATCHES_TABLE_COLUMN_NAME );
      string version ((const char *) sqlite3_column_text( handle, PATCHES_TABLE_COLUMN_VERSION ));
      string release ((const char *) sqlite3_column_text( handle, PATCHES_TABLE_COLUMN_RELEASE ));
      unsigned epoch = sqlite3_column_int( handle, PATCHES_TABLE_COLUMN_EPOCH );
      Arch arch( SqliteAccess::Rc2Arch( (RCArch)(sqlite3_column_int( handle, PATCHES_TABLE_COLUMN_ARCH )) ) );
    ...
    {
      ERR << "Cannot create patch object '" << name << "' from catalog '" << selfSourceRef().id() << "'" << endl;
      sqlite3_reset (handle);
      ZYPP_RETHROW (excpt_r);
    }
  }
...
SqliteSourceImpl::createPatterns(void)
{
  ...
  while ((rc = sqlite3_step (handle)) == SQLITE_ROW)
  {
    ...
    try
    {
      detail::ResImplTraits<SqlitePatternImpl>::Ptr impl( new SqlitePatternImpl( selfSourceRef() ) );
      
      sqlite_int64 id = sqlite3_column_int64( handle, PATTERNS_TABLE_COLUMN_ID );
      name = (const char *) sqlite3_column_text( handle, PATTERNS_TABLE_COLUMN_NAME );
      string version ((const char *) sqlite3_column_text( handle, PATTERNS_TABLE_COLUMN_VERSION ));
      string release ((const char *) sqlite3_column_text( handle, PATTERNS_TABLE_COLUMN_RELEASE ));
      unsigned epoch = sqlite3_column_int( handle, PATTERNS_TABLE_COLUMN_EPOCH );
      Arch arch( SqliteAccess::Rc2Arch( (RCArch)(sqlite3_column_int( handle, PATTERNS_TABLE_COLUMN_ARCH )) ) );
    ...
    {
      ERR << "Cannot create pattern object '" << name << "' from catalog '" << selfSourceRef().id() << "'" << endl;
      sqlite3_reset (handle);
      ZYPP_RETHROW (excpt_r);
    }
  }
...
SqliteSourceImpl::createProducts(void)
{
  ...
  while ((rc = sqlite3_step (handle)) == SQLITE_ROW)
  {
    ...
    try
    {
      detail::ResImplTraits<SqliteProductImpl>::Ptr impl( new SqliteProductImpl( selfSourceRef() ) );
    ...
    {
      ERR << "Cannot create product object '" << name << "' from catalog '" << selfSourceRef().id() << "'" << endl;
      sqlite3_reset (handle);
      ZYPP_RETHROW (excpt_r);
    }
  }
