...
#ifndef ZYPP_SOLVER_TEMPORARY_WORLD_H
#define ZYPP_SOLVER_TEMPORARY_WORLD_H
...
class World : public base::ReferenceCounted, private base::NonCopyable {
  ...
  public:
    ...
    virtual int foreachResItemByKind (const Resolvable::Kind & kind, CResItemFn fn, void *user_data) = 0;
...
#endif // ZYPP_SOLVER_TEMPORARY_WORLD_H
